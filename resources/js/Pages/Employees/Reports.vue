...
const buttons2 = ref([]);
const report = ref('1');
const types = ref([{'id':'1','name':'Jugadores'},{'id':'2','name':'Departamentos'}]);
        ...
        <div class="py-12">
            <div class=" mx-auto sm:px-6 lg:px-8">
                <div class="px-6 py-6  bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <InputLabel for="rep" value="Reporte de:"></InputLabel>
                    <SelectInput id="rep" class="mt-1 block w-3/4"
                        v-model="report" :options="types">
                    </SelectInput>
                </div>
                <div v-if="report == '1'" class="px-6 py-6  bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <DataTable :data="employees" :columns="columns1"
                        ...
                        <tr class="bg-gray-100">
                            ...
                            <th class="px-2 py-2">Edades</th>
                            <th class="px-2 py-2">Departamentos</th>
                            <th class="px-2 py-2"></th>
                            <th class="px-2 py-2"></th>
                        </tr>
                        </thead>
